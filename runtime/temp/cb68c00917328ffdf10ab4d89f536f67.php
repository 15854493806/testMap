<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:31:"./themes/admin/scenic/edit.html";i:1574737506;s:24:"./themes/admin/base.html";i:1574737504;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/scenic/index'); ?>">景区管理</a></li>
          	...
          	<li class=""><a href="<?php echo url('admin/spot/add'); ?>">添加景区</a></li>
        ...
        <div class="layui-tab-content">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form form-container" action="<?php echo url('admin/scenic/update'); ?>" method="post">
				<input type="text" name="id" value="<?php echo $scenic['id']; ?>" style="display:none;">
                        ...
                        <div class="layui-input-block" style="z-index: 999">
                            ...
                            <select name="cid" lay-verify="required" lay-filter="required">
                              <option value="0" selected="">请选择城市</option>
                                ...
                                <?php if(is_array($map) || $map instanceof \think\Collection || $map instanceof \think\Paginator): if( count($map)==0 ) : echo "" ;else: foreach($map as $key=>$map): ?>

                                	<option value="<?php echo $map['id']; ?>" <?php if($map['id'] == $scenic['cid']): ?>selected = "selected"<?php endif; ?>><?php echo $map['name']; ?></option>
                    ...
                    <div class="layui-form-item">
                  	...
                  	<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" value="<?php echo $scenic['name']; ?>" required  lay-verify="required" placeholder="请输入景区名称" class="layui-input">
                        </div>
                    </div>
                  	<div class="layui-form-item">
                        <label class="layui-form-label">景区位置</label>
                      	<div class="layui-input-block">
                            <input type="text" name="coordinate_left" value="<?php echo $scenic['coordinate_left']; ?>" required  lay-verify="required" placeholder="请点击地区图片获取横向坐标" class="layui-input" style="margin-bottom:10px;" disabled="disabled" id="requiredx">
                          	<input type="text" name="coordinate_top" value="<?php echo $scenic['coordinate_top']; ?>" required  lay-verify="required" placeholder="请点击地区图片获取纵向坐标" class="layui-input" style="margin-bottom:10px;" disabled="disabled" id="requiredy">
                        </div>
                        <div class="layui-input-block">
                            <img src="<?php echo $img['img']; ?>" style="width:400px;" id="cityimg">
                        </div>
                    </div>
                   <div class="layui-form-item">
                  	...
                  	<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea name="content" placeholder="" class="layui-textarea" id="content"><?php echo $scenic['content']; ?></textarea>
