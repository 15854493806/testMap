<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"./themes/admin/scenic/add.html";i:1577077447;s:24:"./themes/admin/base.html";i:1574737504;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/scenic/newSave'); ?>" method="post">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input id="lon" type="tel" name="lon" placeholder="点击地图获取经度" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">纬度</label>
                            <div class="layui-input-inline">
                                <input id="lat" type="text" name="lat" placeholder="点击地图获取纬度" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                  	...
                  	<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="content_cn" placeholder="" class="layui-textarea" id="content_cn"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">韩_景区描述</label>
                        <div class="layui-input-block">
                            <textarea name="content_kr" placeholder="" class="layui-textarea" id="content_kr"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
<script>
  ...
  $(function () {
      var map = new AMap.Map("Map", {
          resizeEnable: true,
          center: [119.1063816, 36.7044141],
          zoom: 13
      });
      // 创建一个 Marker 实例：
      var marker = new AMap.Marker({
          position: new AMap.LngLat(119.1063816, 36.7044141),   // 经纬度对象，也可以是经纬度构成的一维数组[116.39, 39.9]
          title: "当前位置",
          label:{
