<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./themes/admin/newscenic/add.html";i:1577863349;s:24:"./themes/admin/base.html";i:1574737504;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/newscenic/Save'); ?>" method="post">
