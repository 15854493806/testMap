<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"./themes/admin/user/index.html";i:1575028255;s:24:"./themes/admin/base.html";i:1574737504;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php if($vo['sex']==0): ?>女<?php endif; if($vo['sex']==1): ?>男<?php endif; ?></td>
                        <td><?php echo $vo['country'].$vo['province'].$vo['city']; ?></td>
                        <td><img src="<?php echo $vo['headimgurl']; ?>" alt=""  width="50px;" height="30px;" /></td>
